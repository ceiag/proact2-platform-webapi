...
namespace Proact.Services.Migrations
{
    ...
    [Migration("20210824135043_MESSAGEDATA_240820211523")]
    partial class MESSAGEDATA_240820211523
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Proact.Services.Entities.Message", b =>
                {
                    ...
                    b.Property<Guid?>("MessageEncryptionInfoId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("MessageEncryptionInfoId");
            ...
            modelBuilder.Entity("Proact.Services.Entities.MessageEncryptionInfo", b =>
                {
                    b.Property<Guid>("MessageEncryptionInfoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("MessageEncryptionInfoId");

                    b.ToTable("MessageEncryptionInfo");
                });
            ...
            modelBuilder.Entity("Proact.Services.Entities.Message", b =>
                {
                    ...
                    b.HasOne("Proact.Services.Entities.MessageData", "MessageData")
                        .WithOne("Message")
                        .HasForeignKey("Proact.Services.Entities.Message", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("Proact.Services.Entities.MessageEncryptionInfo", "MessageEncryptionInfo")
                        .WithMany()
                        .HasForeignKey("MessageEncryptionInfoId");
                    ...
                    b.Navigation("MessageEncryptionInfo");
                });
