...
namespace Proact.Services.Migrations
{
    ...
    partial class ProactDatabaseContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Proact.Services.Entities.MedicalTeams.DataManagersMedicalTeamRelation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DataManagerId");

                    b.HasIndex("MedicalTeamId");

                    b.ToTable("DataManagersMedicalTeamRelations");
                });
            ...
            modelBuilder.Entity("Proact.Services.Entities.MobileAppsInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("AndroidLastBuildRequired")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("iOSLastBuildRequired")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Proact.Services.Entities.ProjectHtmlContent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Proact.Services.Entities.ProjectProperties", b =>
                {
                    ...
                    b.Property<bool>("IsMessagingActive")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Proact.Services.Entities.Researcher", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Proact.Services.Entities.ResearchersMedicalTeamRelation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ResearchersMedicalTeamRelation");
                });
            ...
            modelBuilder.Entity("Proact.Services.Entities.TreatmentHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Proact.Services.Entities.Users.DataManager", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Proact.Services.Entities.MedicalTeams.DataManagersMedicalTeamRelation", b =>
                {
                    b.HasOne("Proact.Services.Entities.Users.DataManager", "DataManager")
                        .WithMany()
            ...
            modelBuilder.Entity("Proact.Services.Entities.NursesMedicalTeamRelation", b =>
                {
                    b.HasOne("Proact.Services.Entities.Users.DataManager", null)
                        .WithMany("MedicalTeamRelations")
                        .HasForeignKey("DataManagerId");
            ...
            modelBuilder.Entity("Proact.Services.Entities.ResearchersMedicalTeamRelation", b =>
                {
                    b.HasOne("Proact.Services.Entities.MedicalTeam", "MedicalTeam")
                        .WithMany("ResearcherRelation")
                        .HasForeignKey("MedicalTeamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Proact.Services.Entities.Researcher", "Researcher")
                        .WithMany("MedicalTeamRelations")
            ...
            modelBuilder.Entity("Proact.Services.Entities.MedicalTeam", b =>
                {
                    ...
                    b.Navigation("DataManagersRelation");
                    ...
                    b.Navigation("ResearcherRelation");
                });
