...
namespace Proact.Services.Migrations
{
    ...
    [Migration("20211217114038_171220211240")]
    partial class _171220211240
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Proact.Services.Entities.SurveysAssignmentsRelation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SurveysAssignmentsRelations");
                });
            ...
            modelBuilder.Entity("Proact.Services.Entities.SurveyQuestion", b =>
                {
                    b.HasOne("Proact.Services.Entities.SurveyQuestionsSet", "QuestionSet")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("Proact.Services.Entities.SurveyUserQuestionAnswer", b =>
                {
                    ...
                    b.HasOne("Proact.Services.Entities.SurveysAssignmentsRelation", "AssignmentRelation")
                        .WithMany()
