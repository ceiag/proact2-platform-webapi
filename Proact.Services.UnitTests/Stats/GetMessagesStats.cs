...
namespace Proact.Services.UnitTests.Stats {
    public class GetMessagesStats {
        ...
        public void _CheckStatsCorrectness() {
            ...
            Assert.Equal( 0, statsProvider.PatientsMessagesStats.MoodVeryBad );
            Assert.Equal( 0, statsProvider.PatientsMessagesStats.MoodBad );
            Assert.Equal( 26, statsProvider.PatientsMessagesStats.MoodGood );
            Assert.Equal( 0, statsProvider.PatientsMessagesStats.MoodVeryGood );
            Assert.Equal( 0, statsProvider.PatientsMessagesStats.MoodNotSpecified );
            Assert.Equal( 0, statsProvider.PatientsMessagesStats.InfoScope );
            Assert.Equal( 26, statsProvider.PatientsMessagesStats.HealthScope );
            Assert.Equal( 0, statsProvider.PatientsMessagesStats.ScopeNotSpecified );
